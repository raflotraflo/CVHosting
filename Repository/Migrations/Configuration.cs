    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Repository.Models.CVHostingContext>
    {
        ...
        private void SeedAvailability(CVHostingContext context)
        {
            List<string> availabilityNames = new List<string>() { "Do 20h tygodniowo", "20h tygodniowo",
                "21h - 29h tygodniowo", "30h - 39h tygodniowo", "Pełen etat (40h)" };
        ...
        {
            List<string> placeNames = new List<string>() { "Z ogłoszenia", "Od pracownika HeadChannel", "Z bloga technicznego",
                "Ze strony www", "Z mediów społecznościowych", "Z uczelni", "Z wcześniejszej rekrutacji", "Inne źródło" };
