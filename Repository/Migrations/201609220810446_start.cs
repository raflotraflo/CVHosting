namespace Repository.Migrations
{
    ...
    public partial class start : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                        Workplace = c.String(nullable: false, maxLength: 72),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.CVApplication", "PlaceId", "dbo.Place");
            DropForeignKey("dbo.CVApplication", "AvailabilityId", "dbo.Availability");
            ...
            DropIndex("dbo.CVApplication", new[] { "AvailabilityId" });
            DropIndex("dbo.CVApplication", new[] { "PlaceId" });
